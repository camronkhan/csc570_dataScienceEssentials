...
# import data
Xy_train = read.csv("../ubuntu/data/midterm_train.csv", stringsAsFactors = FALSE)
X_test = read.csv("../ubuntu/data/midterm_test.csv", stringsAsFactors = FALSE)
...
fitControl <- trainControl(method = "repeatedcv", number = 10, repeats = 400, returnResamp = "all", classProbs = TRUE, summaryFunction = twoClassSummary, verboseIter = TRUE, allowParallel = TRUE)
